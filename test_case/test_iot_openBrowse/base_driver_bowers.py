...
class driver_basePC_class():
    ...
    def setup_class(self):
        #为Linux准备
        executable_path = Service(executable_path='/home/apploadpath/chromedriverPath/chrome-linux64')
        ...
        self.driver = webdriver.Chrome(executable_path,options=chrome_options,service=service)
